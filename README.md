...
- [Tableau](https://github.com/sophiaclare/data_analysis_portfolio#tableau)
  * [Universal Basic Income Pilots](https://github.com/sophiaclare/data_analysis_portfolio#universal-basic-income-pilots)
  * [Penn State DataFest 2021](https://github.com/sophiaclare/data_analysis_portfolio#penn-state-datafest-2021)
- [Python](https://github.com/sophiaclare/data_analysis_portfolio#python)
  * [CFG Python Project - Sales Analysis](https://github.com/sophiaclare/data_analysis_portfolio#cfg-python-project---sales-analysis)
...
- [Data Physicalization](https://github.com/sophiaclare/data_analysis_portfolio#data-physicalization)
  * [Edinburgh's Airbnb Landscape: A Technical Exploration Through Spatial Analysis and 3D Modeling](https://github.com/sophiaclare/data_analysis_portfolio#edinburghs-airbnb-landscape-a-technical-exploration-through-spatial-analysis-and-3d-modeling)
- [MCM/ICM Mathematical Modelling Competition](https://github.com/sophiaclare/data_analysis_portfolio#mcmicm-mathematical-modelling-competition)
  * [Modelling the Spread of Vespa Mandarinia in Washington State](https://github.com/sophiaclare/data_analysis_portfolio#modelling-the-spread-of-vespa-mandarinia-in-washington-state)
...
### [Universal Basic Income Pilots](https://public.tableau.com/views/FinalProject_17128510952690/Story1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

**Description:** Developed an interactive Tableau dashboard titled "Universal Basic Income Pilots," utilizing Tableau's Story feature to explore and visualize global experiments on Universal Basic Income (UBI). The dashboard includes case studies from Finland and India, a detailed timeline of UBI experiments, and an interactive map displaying the geographical distribution of these experiments. The project also visualizes key metrics such as the average length of experiments, the number of participants, and the types of funding involved. This dashboard provides stakeholders with a comprehensive overview of UBI initiatives worldwide and supports data-driven discussions on social welfare policies.

**Skills:** Data visualization, storytelling with data, spatial analysis, interactive dashboard creation, data cleaning and preparation, statistical analysis.

**Technology:** Tableau Public, Tableau Story feature, data from public databases and research studies.
...
**Description:** Entry for a competition held at Penn State in 2021, where each group is given a task and a data set to work with. My group received data on the Opioid Epidemic in Germany and were required to create data visualizations and a predictive model for risk levels.

**Skills:** Data cleaning, data analysis, data visualization, statistical modeling.
...
![alt text](https://raw.githubusercontent.com/sophiaclare/images/main/Physicalization%20AirBnb.png)
